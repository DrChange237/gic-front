  ...
  openModal(content: TemplateRef<never>,  agency: Agency) {
    ...
    this.accountSrv.getDetailAgency(agency.id).subscribe({
      next: res => {
        ...
        this.datasAgency.push({key: 'account', label: 'Account', value: `${agency.account.agencyCode}-${agency.account.accountNumber}-${agency.account.accountKey}`});
        this.datasAgency.push({key: 'accountCommission', label: 'Account Commission', value: `${agency.accountCommission.agencyCode}-${agency.accountCommission.accountNumber}-${agency.accountCommission.accountKey}`});
